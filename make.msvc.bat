...
:: Visual Studio 2015
:vc-set-2013
if not defined VS150COMNTOOLS  goto vc-set-2014
if not exist "%VS150COMNTOOLS%\..\..\vc\vcvarsall.bat" goto vc-set-2014
echo -
echo - Visual C++ 2015 found.
echo -
call "%VS170COMNTOOLS%\..\..\vc\vcvarsall.bat" %vs_toolset%
goto STARTCOMPILING
...
set CL_FILES="XConnectLib\Common.cpp" "XConnectLib\Conversion.cpp" "XConnectLib\XCRead.cpp" "XConnectLib\XCReaders.cpp" "XConnectLib\XCWrite.cpp" "XConnect\XCSession.cpp" "XConnect\main.cpp"
...
set LINK_OBJS="Common.obj" "Conversion.obj" "XCRead.obj" "XCReaders.obj" "XCWrite.obj" "XCSession.obj" "main.obj"

@ECHO ON

cl.exe  %CL_OPTS% %CL_DEFS% /I SDK\CHeaders\XPLM /I XConnectLib /I XConnect %CL_FILES%
